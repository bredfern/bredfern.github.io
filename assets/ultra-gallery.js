  ...
  render() {
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .stage { width: 80%; height: 290px; position: relative; transform-style: preserve-3d; transition: transform 1s cubic-bezier(0.2, 0, 0, 1); }
        ::slotted(*) { width: 80%; height: 260px; margin-top: 1rem; border-radius: 20px; object-fit: cover; }
