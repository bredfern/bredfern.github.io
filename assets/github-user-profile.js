    ...
    render() {
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .github-link { display: block; text-align: center; margin-top: 15px; padding: 8px 15px; background-color: #fff; color: #e3e3ff; text-decoration: none; border-radius: 4px; font-weight: 500; font-size: 0.9em; transition: background-color 0.2s; }
