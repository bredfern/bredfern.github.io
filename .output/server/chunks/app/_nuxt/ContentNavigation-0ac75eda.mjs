...
import { d as useState, f as useContentDisabled, g as useAsyncData, u as useRuntimeConfig, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, b as useContentPreview } from '../server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-598cb937.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-0ac75eda.mjs.map
